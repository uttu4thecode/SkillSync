...
*   SQLAlchemy (ORM)
*   **Advanced LLM Integration** (Career Insights Engine)
*   **spaCy / NLP** (Skill Extraction)

**Frontend**
*   Modern Responsive UI (HTML5, CSS3, Vanilla JavaScript)
*   Dynamic Dashboards
...
*   **Full-Stack Architecture:** Built a secure, state-managed dashboard with persistent storage.
*   **Scalable Design:** Implemented a modular service layer for both NLP and AI engines.
